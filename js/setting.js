...
OpenSpending.identifier = 'ibaraki_mito_2013';
...
OpenSpending.Styles.Cofog = {
  ...
  '201': { icon: 'icons/publicaffairs.svg', color: '#C75746', bcolor: '#0AB971' }, // 総務費 総務費
  '3': { icon: 'icons/family.svg', color: '#C75746', bcolor: '#4E6D00' }, // 民生費
  '301': { icon: 'icons/family.svg', color: '#C75746', bcolor: '#4E6D00' }, // 民生費 民生費
  '4': { icon: 'icons/health.svg', color: '#C75746', bcolor: '#D33673' }, // 衛生費
  '401': { icon: 'icons/health.svg', color: '#C75746', bcolor: '#D33673' }, // 衛生費 衛生費
  '5': { icon: 'icons/environment.svg', color: '#C75746', bcolor: '#2A3A03' }, // 労働費
  '501': { icon: 'icons/environment.svg', color: '#C75746', bcolor: '#2A3A03' }, //　労働費 労働費
  '6': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#EC2406' }, // 農林水産費
  '601': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#EC2406' }, // 農林水産費 農林水産費
  ...
  '801': { icon: 'icons/coal.svg', color: '#C75746', bcolor: '#C75746' }, // 土木費 土木費
  ...
  '1001': { icon: 'icons/schools.svg', color: '#C75746', bcolor: '#790586' }, // 教育費 教育費
